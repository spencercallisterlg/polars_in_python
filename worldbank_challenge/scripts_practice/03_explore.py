...
info = pl.read_csv("../data/Metadata_Indicator_API_Download_DS2_en_csv_v2_5657328.csv").rename(new_names)


# %%
# Now let's build an indicator variable summary table to know which variables are 
# the most avaiable over all the countries and save it to data/dat_vars.parquet
