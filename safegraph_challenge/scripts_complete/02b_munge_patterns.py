...
# %%
dat = patterns.unique(subset=["placekey", "date_range_start"]).join(places.unique(subset="placekey"), on=["placekey"], how="left")
# %%
dat.write_parquet("../data/patterns_places.parquet")
# %%
